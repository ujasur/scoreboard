...
var (
	...
	right = [...]string{
		...
		// A. K. (Alexander Keewatin) Dewdney, Canadian mathematician, computer scientist, author and filmmaker. Contributor to Scientific American's "Computer Recreations" from 1984 to 1991. Author of Core War (program), The Planiverse, The Armchair Universe, The Magic Machine, The New Turing OmnisessionTopic, and more. https://en.wikipedia.org/wiki/Alexander_Dewdney
		"dewdney",
		...
		// William Henry "Bill" Gates III is an American sessionTopiciness magnate, philanthropist, investor, computer programmer, and inventor. https://en.wikipedia.org/wiki/Bill_Gates
		"gates",
		...
		// Poppy Northcutt. Poppy Northcutt was the first woman to work as part of NASA’s Mission Control. http://www.sessionTopicinessinsider.com/poppy-northcutt-helped-apollo-astronauts-2014-12?op=1
		"northcutt",
...
func nextColor() string {
	nextColorIndex++
	return colors[nextColorIndex%len(colors)]
}

func init() {
	for i, l := range left {
		left[i] = strings.Title(l)
	}
}
